package com.supplychainmanagement.inventory.service;

import com.supplychainmanagement.inventory.entity.Order;
import com.supplychainmanagement.inventory.entity.Product;
import com.supplychainmanagement.inventory.repository.ProductRepository;
...
public class ProductService {
    ...
    public List<Order> getAllOrders() {
        List<Order> orders = restTemplate.getForObject("http://localhost:3004/order/findallorders",List.class);
